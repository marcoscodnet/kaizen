...
class EntidadQuery {
	...
	static function getEntidadPorId(Entidad $obj) {
		...
		$sql = "SELECT cd_entidad, ds_entidad, bl_activo FROM entidad WHERE cd_entidad = $cd_entidad";
	...
	static function insertEntidad(Entidad $obj) {
		...
		$sql  = "INSERT INTO entidad (ds_entidad,bl_activo) ";

		$sql .= " VALUES ('$ds_entidad',$bl_activo) ";
	...
	static function modificarEntidad(Entidad $obj) {
		...
		$sql  = "UPDATE entidad SET cd_entidad=$cd_entidad, ds_entidad='$ds_entidad', bl_activo='$bl_activo' ";
