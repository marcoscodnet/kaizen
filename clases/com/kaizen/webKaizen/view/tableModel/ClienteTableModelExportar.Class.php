...
class ClienteTableModelExportar extends ListarTableModel{

	private $columnNames = array('Codigo', 'Apellido y nombre', 'DNI', 'Te. Particular', 'Te. Movil', 'Localidad',	'Provincia','Nacimiento','Condicion','E-mail');

	private $columnWidths = array(10, 90,20, 30, 20, 20, 30,20,40);
	
	public function ClienteTableModelExportar(ItemCollection $items){
		$this->items = $items;
	}
