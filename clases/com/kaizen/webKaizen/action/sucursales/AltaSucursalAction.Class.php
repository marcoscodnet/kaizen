...
/**
 * Acción para dar de alta un sucursal.
 * 
 * @author Lucrecia
 * @since 18-01-2011
 * 
 */
class AltaSucursalAction extends EditarSucursalAction{
	...
	protected function editar($oEntidad){
		...
		$manager->agregarSucursal($oEntidad);
	}
