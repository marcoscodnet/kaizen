...
/**
 * Acción para modificar un sucursal.
 * 
 * @author Lucrecia
 * @since 18-01-2011
 * 
 */
class ModificarSucursalAction extends EditarSucursalAction{
	/**
	 * (non-PHPdoc)
	...
	protected function editar($oEntidad){
		...
		$manager->modificarSucursal($oEntidad);
	}
	...
	protected function getForwardSuccess(){
		return 'modificar_sucursal_success';
	}
	...
	protected function getForwardError(){
		return 'modificar_sucursal_error';
	}
