...
/**
 * Acción para modificar un consumo estimado de productos.
 *
 * @author Lucrecia
 * @since 21-01-2011
 * 
 */
class ModificarConsumoEstimadoAction extends EditarConsumoEstimadoAction{
	...
	protected function editar($oEntidad){
		...
		$manager->modificarConsumoEstimado( $oEntidad );
	...
	protected function getForwardSuccess(){
		return 'modificar_consumoEstimado_success';
	}
	...
	protected function getForwardError(){
		return 'modificar_consumoEstimado_error';
	}
