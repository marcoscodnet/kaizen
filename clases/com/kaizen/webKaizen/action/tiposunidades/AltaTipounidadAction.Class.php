 ...
 * 
 */
class AltaTipounidadAction extends EditarTipounidadAction{
	...
	protected function editar($oEntidad){
		...
		$manager->agregarTipounidad($oEntidad);
	}
	...
	protected function getForwardSuccess(){
		return 'alta_tipounidad_success';
	}
