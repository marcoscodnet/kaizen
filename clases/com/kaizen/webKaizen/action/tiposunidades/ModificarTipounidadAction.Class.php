 ...
 * 
 */
class ModificarTipounidadAction extends EditarTipounidadAction{
	/**
	 * (non-PHPdoc)
	...
	protected function editar($oEntidad){
		...
		$manager->modificarTipounidad($oEntidad);
	}
	...
	protected function getForwardSuccess(){
		return 'modificar_tipounidad_success';
	}
	...
	protected function getForwardError(){
		return 'modificar_tipounidad_error';
	}
