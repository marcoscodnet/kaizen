...
/**
 * Acción para modificar un entidad.
 * 
 * @author Lucrecia
 * @since 18-01-2011
 * 
 */
class ModificarEntidadAction extends EditarEntidadAction{
	/**
	 * (non-PHPdoc)
	...
	protected function editar($oEntidad){
		...
		$manager->modificarEntidad($oEntidad);
	}
	...
	protected function getForwardSuccess(){
		return 'modificar_entidad_success';
	}
	...
	protected function getForwardError(){
		return 'modificar_entidad_error';
	}
