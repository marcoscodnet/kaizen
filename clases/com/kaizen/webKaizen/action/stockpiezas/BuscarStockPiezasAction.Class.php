 ...
 *
 */
class BuscarStockPiezaAction extends ListarAction {
	...
	protected function getListarTableModel(ItemCollection $items) {
		return new BuscarStockPiezaTableModel($items);
	}
	...
	protected function getXTemplate() {
		return new XTemplate(APP_PATH . 'stockpiezas/buscarstockpiezas.html');
	}
	...
	protected function getTitulo() {
		return 'Buscar Stock Piezas';
	}

	protected function getUrlAccionListar() {
		return 'buscar_stockpiezas';
	}
