...
/**
 * Acción para modificar un marca.
 * 
 * @author Lucrecia
 * @since 10-01-2011
 * 
 */
class ModificarMarcaAction extends EditarMarcaAction{
	...
	protected function editar($oEntidad){
		...
		$manager->modificarMarca( $oEntidad[0], $oEntidad[1] );
	}
	...
	protected function getForwardSuccess(){
		return 'modificar_marca_success';
	}
