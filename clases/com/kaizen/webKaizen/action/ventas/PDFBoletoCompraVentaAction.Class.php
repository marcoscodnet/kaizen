 ...
 * Acci�n para exportar a pdf un formulario de venta
...
class PDFBoletoCompraVentaAction extends SecureAction{
	...
	public function parseContenido(PDFPrint $pdf, Venta $oVenta, $y){
		...
		$texto_footer = "En prueba de conformidad se firman dos ejemplares del mismo tenor y a un solo efecto en la ciudad de $localidad_sucursal, a los $dia_hoy d�as, del mes de $mes_hoy de $anio_hoy";
	...
	function parseFooterDuplicado($pdf, $oVenta){
		...
		$pdf->Cell(180, 4, "DETALLE DE LA OPERACI�N", 0, 1, "C");
	...
	function parseUnidad($pdf, $oVenta){
		...
		//TITULOS: Tipo Marca Modelo A�o Modelo
		...
		$pdf->Cell(45, 4, "A�o - Modelo", "R",1, "L");
	...
	function parseCliente($pdf, $oVenta){
		...
		$texto = "Conste por el presente que en el lugar y fecha indicados en el pie de la presente, se realiza la operaci�n de Venta detallando los datos del titular y del respectivo bien.";
		...
		$pdf->Cell($celda_width - 110, 4, "Apellido y nombre/Raz�n Social:", "LT",0, "L");
		...
		$pdf->Cell(20, 4, "C�d. Postal:", 0,0, "L");
