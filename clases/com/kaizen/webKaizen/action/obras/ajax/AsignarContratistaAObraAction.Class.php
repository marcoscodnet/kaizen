<?php
/**
 * Acción para agregar en sesión un contratista utilizando Ajax.
 * 
 * @author Lucrecia
 * @since 09-04-2010
 *
 */
class AsignarContratistaAObraAction extends EditarContratistaDeObraAction{

	
	/**
	 * se agrega un contratista en sesión.
	 */
	...
	public function getTrabajadorObra(){
		...
		if (isset ( $_GET ['cd_contratista'] ) ){
			
			$cd_trabajadorObra = addslashes ( $_GET ['cd_contratista'] ) ;
