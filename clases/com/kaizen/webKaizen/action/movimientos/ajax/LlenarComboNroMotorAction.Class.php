...
class LlenarComboNroMotorAction extends SecureAjaxAction{
	protected $path_html;
	protected $class;
	protected $required;
	/**
	...
	public function executeImpl(){
		...
		try{
			$unidades = $manager->getNrosmotorDeProducto($cd_producto, $cd_sucursal);
	...
	protected function parseEntidad ($entidad, $xtpl){
		$xtpl->assign ( 'nu_motor', htmlentities( $entidad->getNu_motor()));
