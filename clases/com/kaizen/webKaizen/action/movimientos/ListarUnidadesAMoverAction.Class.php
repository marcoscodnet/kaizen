 ...
 *
 */
class ListarUnidadesAMoverAction extends ListarAction {
    ...
    protected function getXTemplate() {
        return new XTemplate(APP_PATH . 'movimientos/listar_unidadesamover.html');
    }
	...
	protected function getFiltrosEspeciales(){
		$xtpl =  new XTemplate(APP_PATH .  'movimientos/criterio_unidadesamover.html');
    ...
    protected function parseAccionesDefault(XTemplate $xtpl, $entidad, $id, $nombre_entidad, $lbl_entidad=null, $ver=true, $modificar=true, $eliminar=true, $autorizar = true, $mover=true) {
        ...
        if ($mover) {
            $href = 'doAction?action=alta_movimiento_init&id=' . $id;
            $onClick = "moverUnidad('doAction?action=alta_movimiento_init&id=" . $id . "');return false;\"";
            $this->parseAccion($xtpl, $onClick, $href, 'img/mover.png', 'Mover unidad a sucursal' . $lbl_entidad);
        }
    }
    ...
    protected function getTitulo() {
        return 'Listar unidades a mover';
    }

    protected function getUrlAccionListar() {
        return 'listar_unidadesamover';
    }
