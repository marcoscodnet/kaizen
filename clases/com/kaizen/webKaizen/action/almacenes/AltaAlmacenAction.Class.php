...
/**
 * Acción para dar de alta un almacén.
 * 
 * @author Lucrecia
 * @since 15-04-2010
 * 
 */
class AltaAlmacenAction extends EditarAlmacenAction{
	...
	protected function editar($oEntidad){
		...
		$manager->agregarAlmacen($oEntidad);
	}
